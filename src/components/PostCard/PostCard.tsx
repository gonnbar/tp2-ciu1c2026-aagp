  ...
  return (
    <div className="mb-6 rounded-xl bg-surface p-5 shadow-md">
      <div className="flex flex-col md:flex-row gap-6">
       ...
       <Link to={`/posts/${id}`} className="flex items-center gap-2 text-gray-500 hover:text-primary transition">
        ...
        <div className="flex flex-col items-center">
         ...
         <Link to={`/posts/${id}`}className="mt-4 rounded-lg bg-primary px-4 py-2 text-white hover:opacity-90 text-center"> Ver más</Link>
        </div>
      </div>
    </div>
  );
