...
export default function Welcome() {
  ...
  return (
    <div className="relative min-h-[100svh] overflow-hidden bg-gradient-to-br from-[#3F2B96] via-[#6A4CDB] to-[#D16BA5]">
      ...
      <div className="relative z-10 flex min-h-[100svh] flex-col items-center justify-center text-center">
        ...
        <div className="mt-10 flex flex-col sm:flex-row gap-4">
          <Link
            to="/login"
            className="rounded-xl bg-white px-8 py-3 font-semibold text-primary transition-all duration-300 hover:scale-105"
          >
            Iniciar sesión
          </Link>
          <Link
            to="/register"
            className="rounded-xl border-2 border-white px-8 py-3 font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-white hover:text-primary"
          >
            Registrarse
          </Link>
        </div>
